 ...
 *   PROXY_URL=http://localhost:5030   URL base do proxy  (padrão: http://localhost:5030)
...
const PROXY_URL  = (process.env.PROXY_URL  || "http://localhost:5030").replace(/\/$/, "");
...
async function coletar() {
  ...
  console.log("╚══════════════════════════════════════════════════════════════╝\n");
  console.log("  Próximo passo: acesse http://localhost:5030 — o portal usará");
